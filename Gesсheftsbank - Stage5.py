#Gesсhaftsbank - Stage5. Внесение изменений, скоринг и платёжный календарь
#Основные задачи:
#   МОДЕЛЬ КРЕДИТНОГО СКОРИНГА
#   ПЛАТЁЖНЫЙ КАЛЕНДАРЬ - основная задача на данный этап после ввода скоринга
#   Сформировать резервы - пилота
#   Дополнить проверки на балансовые показатели
#   Написать краулер, тянущий данные отсюда https://www.cbr.ru/hd_base/
...
risk_free_rate = rfr/100 # раньше было 0.06, но теперь пусть будет rfr
